...
1. [Сделать fork из репозитория][startProject]
...
5. Добавить конфигурацию запуска через Идею. Реализацию этого пункта можно посмотреть в лекции https://javarush.com/quests/lectures/jru.module3.lecture02 (пункт 4). Единственное отличие – другое название артефакта.
...
12. Было бы интересно посмотреть, какие именно запросы выполняет Hibernate, поэтому добавим логирование запросов. Для этого добавь в pom.xml зависимость **p6spy:p6spy:3.9.1.** В папке ресурсов создай файл **spy.properties**, в котором укажи:
   ...
   [startProject]: <https://github.com/vasylmalik/project-hibernate-1>
